...
git remote add origin https://github.com/sixeyed/eshopweb.git
```
...
[You can check on the workflows here](https://github.com/sixeyed/eshopweb/actions). The actions use secrets from your repo to connect to Azure. Then they:
...
```
az aks browse --resource-group eshopweb --name eshopweb-aks
```
